...
export const AuroraBackground = ({
	...
	return (
		<main>
			<div
				className={cn('transition-bg relative flex h-[100vh] w-screen flex-col items-center justify-center', className)}
				{...props}
			>
				<div
					...
					style={
						{
							'--aurora':
								'repeating-linear-gradient(100deg,#7158ea_10%,#a5b4fc_15%,#93c5fd_20%,#ddd6fe_25%,#60a5fa_30%)',
							'--dark-gradient':
